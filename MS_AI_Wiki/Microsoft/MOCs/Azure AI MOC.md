...
Neue Foundation-Erweiterungen — siehe [[2026-06-03-microsoft-build-recap]]:

- **[[MAI Models]]** — Microsoft's neue First-Party-Modellfamilie (7 Modelle): MAI-Thinking, MAI-Code, MAI-Image, MAI-Voice, MAI-Transcribe, MAI-Small/Large, MAI-Embed
- **[[Aion Models]]** — On-Device-Modelle in Windows AI APIs (Aion Instruct + Aion Plan 14B)
- **[[Foundry Models]]** und **[[Foundry Control Plane]]** signifikant erweitert (siehe jeweilige Notes)
