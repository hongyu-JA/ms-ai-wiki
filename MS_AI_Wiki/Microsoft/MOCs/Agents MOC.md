...
Neue Produkte aus Microsoft Build 2026, noch als Stub — siehe [[2026-06-03-microsoft-build-recap]]:

- **[[Agent Orchestrator]]** — Foundry-Orchestrierungs-Service für heterogene Agent-Teams (Preview 08/2026)
- **[[Agent Control Specification]]** — portable Runtime-Governance-Spezifikation für Agenten
- **[[Microsoft Scout]]** — always-on personal Agent (Frontier-Tier)
- **[[Microsoft Execution Containers]]** — OS-level Sicherheits-Container für Agenten
